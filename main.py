...
class Game:
        ...
        while self.playing:
            if self.players == 1:
                if self.luigi.health > 0:
                    ...
                    self.playSong(26.056,109.552,"Melty Molten Galaxy")
                else:
    ...
    def splashScreen(self):
        ...
        while waiting:
            ...
            if self.players == 1:
                self.drawText("The longest time is " + str(self.bestDisplayTime) + ", by the way", 20, white, width / 2,
                              height * 3 / 4 + 50)
            else:
                self.drawText("The longest time is " + str(self.bestDisplayTime2P) + ", by the way", 20, white, width / 2,
                              height * 3 / 4 + 50)
            pg.display.flip()
        pg.mixer.music.stop()
        self.song_playing = ""
